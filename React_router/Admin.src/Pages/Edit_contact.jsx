    ...
    const submithandel = async (e) => {
        ...
        if (validation()) {
            ...
            if (res.status == 200) {
                ...
                setFormvalue({ ...formvalue, name: "", email: "", mobile: "", img: "",comment:"" });
                    ...
                    <div className="col-md-12 col-sm-12 col-xs-12">
                        <div className="panel panel-primary">
                            ...
                            <div className="panel-body">
                                ...
                                <div className="form-group">
                                    <label>Comment</label>
                                    <input type="text" value={formvalue.comment} onChange={changehandel} className="form-control" id="comment" placeholder="Enter comment" name="comment" />
                                    <p className="help-block">Help text here.</p>
                                </div>
